...
$tanggal_close = $data['tanggal_close'] ?? null;
...
if (!$nomor_tiket || !$tanggal_open || !$tanggal_close || !$pelabuhan || !$jenis_perangkat || !$lokasi_perangkat) {
...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO report (nomor_tiket, tanggal_open, tanggal_close, pelabuhan, jenis_perangkat, lokasi_perangkat, layanan_terdampak, keterangan) VALUES (:nomor_tiket, :tanggal_open, :tanggal_close, :pelabuhan, :jenis_perangkat, :lokasi_perangkat, :layanan_terdampak, :keterangan)");

    // Bind parameters
    $stmt->bindParam(':nomor_tiket', $nomor_tiket);
    $stmt->bindParam(':tanggal_open', $tanggal_open);
    $stmt->bindParam(':tanggal_close', $tanggal_close);
