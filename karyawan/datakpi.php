...
// Ambil nama dan ID user dari session
...
$sql = "SELECT 
        ...
        WHERE k.user_id = $logged_in_user_id";

// ====== Tambahkan Filter jika ada ======
if ($periode_id > 0) {
    $sql .= " AND pp.id = $periode_id";
}
...
// Ambil daftar periode buat dropdown
...
<head>
    ...
    <title>KPI Nutech Operation - Data KPI</title>
                ...
                <div class="table-responsive">
                    ...
                    <form method="GET" class="mb-3 row">
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            <a href="cetak_all_kpi.php?periode_id=<?= $periode_id ?>" 
                               target="_blank" 
