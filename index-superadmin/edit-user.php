...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    $id = $_GET["id"];
    $sql = "SELECT id, first_name, last_name, email, divisi, role_id FROM users WHERE id=$id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE users SET first_name='$first_name', last_name='$last_name', email='$email', divisi='$divisi', role_id='$role_id' WHERE id=$id";
...
<head>
    ...
    <title>Port Report Issues - Edit User</title>
